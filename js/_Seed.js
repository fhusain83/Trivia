...
<Body! <script>
 ...
 /*  $(document).ready(function()
    {
var config = {
    apiKey: "AIzaSyCFxkiU7ZTkOl49mSITDKzx6r-wnHOb0A8",
    authDomain: "trivia-bdf41.firebaseapp.com",
    databaseURL: "https://trivia-bdf41.firebaseio.com",
    projectId: "trivia-bdf41",
    storageBucket: "trivia-bdf41.appspot.com",
    messagingSenderId: "508329070378"
  };
...
/*for(var e=1;e<Decor.length;e++)
{
var addstr="questions/decor/question"+e;
var ques=database.ref(addstr);


ques.push(Decor[e].Q);
ques.push(Decor[e].Option1);
ques.push(Decor[e].Option2);
ques.push(Decor[e].Option3);
ques.push(Decor[e].Option4);
ques.push(Decor[e].CorrectOption);*/
}


module.exports.Decor=Decor;
//module.exports.Fashion=Fashion;